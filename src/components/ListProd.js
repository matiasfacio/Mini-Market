              ...
              return (
                <div key={index} className="producto">
                  ...
                  <button
                    ...
                    style={{ backgroundColor: !t.available ? "red" : "green" }}
                  ...
                  <button
                    ...
                    style={{
                      textDecoration: t.display ? "line-through" : "none",
                      border: t.display ? "2px red solid" : "none",
                    }}
                    onClick={() => {
          ...
          >
            <div className="flex_form">
              <div>
                ...
                <input
                  type="number"
                  value={ProductsAvailable.length + 2}
                  onChange={(e) =>
                    ...
                    <div key={index} className="displayCart">
                      ...
                      <div className="cart_button_del">
                        <button
                          style={{ padding: 5 }}
                          onClick={() =>
                            dispatch({ type: "DEL_CART", t, index })
                          }
                        >
                          Del
                        </button>
